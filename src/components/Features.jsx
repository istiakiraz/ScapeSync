    ...
    return (
        <div className='grid lg:grid-cols-4 grid-cols-2  gap-10 mt-18' >
            ...
            <div className='lg:border-r-2 border-gray-100' >
                ...
                <p className='text-gray-500 mt-2 text-sm max-w-[250px] ' >Comprehensive reporting and insights to improve business operations and efficiency.</p>
            </div>
            <div>

                <img className='bg-[#ecfceb] rounded-xl p-2' src={svg3} alt="svg img" />
                <h2 className='font-bold mt-8' >Secure & Reliable</h2>
                <p className='text-gray-500 mt-2 text-sm max-w-[250px] ' >Enterprise-grade security with 99.9% uptime guarantee and data protection.</p>
            </div>
        </div>
    )
}
